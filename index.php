...
<html lang="en">
  ...
  <head>
    ...
    <meta name="description" content=">A nonprofit committed to instilling a love
    of reading in order to improve the quality of education for disadvantaged
    children in India.">
    <link rel="icon" href="resources/icons/flavicon.png">
    <meta http-equiv="Content-Type" content="text/html;charset=utf-8" />
    <link rel=”canonical” href=”https://nachiketchildrenslibraries.org” />
    ...
    <?php require "header.html"?>
      <div id="slideshow-container">
        <div class="slide fade" style="max-width: calc(max(25vw, 70vh)/2*3); display: block;">
          <img class="slide-image" src= "resources/images/Slides/IMG_0297.JPG" alt = "Girl with a book">
          <div class="slide-text-container one">
            <div class="slide-text"><h1 style="all: inherit;">Nachiket Children's Libraries</h1></div>
            <a href="about"><div class="slide-button" style="background-color: #F9992F;">
              <h2>About Us</h2>
            </div></a>
          </div>
        </div>

        <div class="slide fade" style="max-width: calc(1.4*max(25vw,70vh)/2*3);">
          <img class="slide-image" src= "resources/images/Slides/DSCF0868.JPG" style="object-position: right bottom; overflow: hidden; width: inherit;"  alt = "Nachiket readers with new reading materials">
          <div class="slide-text-container two">
            <div class="slide-text" style="text-align: center;">Reinventing Libraries</div>
            <a href = "services"><div class="slide-button" style= "background-color: #428A19";>
              <h2>Our Work</h2>
            </div></a>
          </div>
        </div>
        ...
        <div class="slide fade">
          <img class="slide-image" src= "resources/images/Slides/IMG_0208.JPG" style="object-position: left center;" alt="Nachiket reader with book">
          <div class="slide-text-container three">
            <div class="slide-text" style="text-align: left;">Creating Infinite Possibilities</div>
            <a href = "gallery#Readers"><div class="slide-button" style= "background-color: #15368A";>
              <h2>The Children</h2>
            </div></a>
          </div>
        </div>
        ...
        <div class="slide fade">
          <img class="slide-image" src= "resources/images/Slides/IMG_0585.JPG" alt="Ox drawn cart carrying Nachiket readers">
          <div class="slide-text-container four">
            <div class="slide-text" style="text-align: left;">Improving lives through literacy</div>
            <a href = "gallery#Community"><div class="slide-button" style= "background-color: #F9992F";>
              <h2>Our Community</h2>
            </div></a>
          </div>
        </div>
        ...
        <div class="slide fade">
          <img class="slide-image" src= "resources/images/Slides/artwork.jpg" style="object-position: left bottom; object-fit: cover;" alt="Children's artwork depicting library">
          <div class="slide-text-container five">
            <div class="slide-text" style="text-align: center;">Developing children's talents</div>
            <a href="gallery#Artwork"><div class="slide-button" style= "background-color: #428A19";>
              <h2>Their Artwork</h2>
            </div></a>
          </div>
        </div>
        ...
        <div class="slide fade">
          <img class="slide-image" src= "resources/images/Slides/DSCN1536 (2).JPG" style="object-position: center top; object-fit: cover;" alt="A volunteer at Nachiket">
          <div class="slide-text-container six">
            <div class="slide-text" style="text-align: center;">Volunteer at Nachiket</div>
            <a href="volunteer"><div class="slide-button" style= "background-color: var(--blue);";>
              <h2>Join Us</h2>
            </div></a>
          </div>
        </div>
            ...
            <div class="work-display">
              <div class="work-item big" style="background-image: url('resources/images/Work/IMG_2928.JPG');">
                <div class="work-text" style= "--work-text-expand-height: 190px">
                  <h3>Inspiring a love of reading</h3>
              ...
              <div class="work-display">
                <div class="work-item artwork-work-item" style="background-image: url('resources/images/Work/Scan17.jpg');">
                  <div class="work-text" style= "--work-text-expand-height: 220px">
                    <h3>Holistic literacy through art</h3>
                ...
                <div class="work-item science-work-item">
                  <div class="work-text" style= "--work-text-expand-height: 220px">
                    <h3>Interactive science programs</h3>
                    <p class = "work-text-paragraph">Recently Nachiket Libraries has
              ...
              <div class="work-item big" style="background-image: url('resources/images/Work/IMG_0690.JPG'); background-position: left top;">
                <div class="work-text" style= "--work-text-expand-height: 170px">
                  <h3>Brighter futures through education</h3>
