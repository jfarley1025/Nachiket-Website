...
<html lang="en">
  ...
  <div class="content-container">
    <div class="content">
      <h2 class="content-title" style="border-color: var(--orange)">Our Vision</h2><br>
      ...
      <p>Reading will promote independent thinking thus empowering
  ...
  <div class="content-container name-background">
    <div class="content">
    ...
    <div class="content">
      <h2 class="content-title" style="border-color: var(--green)">Our History</h2><br>
        ...
        <p>To start a new library in a rural area, we usually rent a room that
          ...
          Nachiket library is run with the help of volunteers and some paid
          librarians or trained persons. All libraries are open for four hours
          after school and the whole day on weekends. Some of our libraries are
          open in the morning on weekdays as well.
        </p>
    </div>
  </div>
    ...
    <div class="content" style="padding-top:20px;">
      <div class="quote-container resizeable">
        ...
        <div class="quote-plus-author serif">
          <div class="quote">
            Imagine the thrill of entering a library for the first time. At
            Nachiket we get to choose a book we like. Now we are discovering the
            joy of reading and we are grateful for this unique gift.
          <div class="quote-author">
            &ndash; Readers from Nachiket's Rural Branches
          </div>
        </div>
      </div>
      <div class="quote-mark-container">
        ...
        <div class="about-item">
          ...
          <div class="about-item-text">
            ...
            <p>This room provides a warm, safe, and inviting place where the
              ...
              read, to work on school projects, to take a leisurely look at the
              display material, to interact with each other, and to hold group
              activities.
            </p>
          </div>
        </div>
  ...
  <div class="content-container" style="  height: max-content;padding-bottom:0;background: #4B4B4B;">
    <div class="content">
      <h2 class="content-title" style="border-color: var(--orange); color: white;">Our Staff</h2><br>
      <p style="color: white; text-align: center">We employ people from local communities. This way it's easier for
        our staff members to get the community involved and thus build
        trust. Teachers and people that are associated with the elected
        governing body are invited to give special presentations and
        preside over workshops and competitions. Our staff know how to
        ...
        <div class="staff-images">
          <?php
           ...
           // Target directory
           $dir = 'resources/images/About/Staff/Icons';
           if (is_dir($dir)){
  ...
  <div class="content-container">
    <div class="content">
      <h2 class="content-title" style="border-color: var(--blue)">Our Geography</h2><br>

      <div id="geographyContainer" class="about-container">
        <div id="geography-text-container">
          <p>Amravati District covers 12,235 km&sup2;, but is only 0.004% of India.
            ...
            the towns and fields and communities in which they are being used.</p><br>

            <p>Amravati District has a population of close to 3 million people,
            ...
            population is illiterate, rising to 24% in rural areas.</p><br>
    ...
    <div class="content-container" style="background: #F6F5F2;">
      <div class="content" style="padding-top:20px;">
        <div class="quote-container resizeable">
          ...
          <div class="quote-plus-author serif">
            <div class="quote">
              Nachiket Libraries are inspiring and showing us how to create a
              love for reading in our children's minds.
            <div class="quote-author">
              &ndash; Mrs. Shobha Shyam Pampaliya (A Parent)
            </div>
          </div>
        </div>
        <div class="quote-mark-container">
    ...
    <div class="content-container" style="  height: max-content;padding-bottom:0;background: #4B4B4B;">
      <div class="content">
        <h2 class="content-title" style="color:white; border-color: var(--green);">Our Activities</h2><br>
        <p style="color:white;">
          At Nachiket we provide a creative learning forum to awaken and
          support children's intellectual curiosity and imaginative power.
          Activities such as drawing, painting, storytelling,dance, readings
          by children's authors, reading out loud in groups, and writing
          workshops are routinely held. In some libraries, we have monthly
          interactive science programs that explore various science concepts
          with the help of experiments. Children are so happy just to get
          their hands on nice paper and colouring materials that they pour
          their hearts out. We also offer activities developed by Doorstep
          School, Pune, to improve children's reading skills. Children enjoy
          practicing their reading, public speaking, and preforming skills.
          Girls are winning competitions in schools, are publishing an
          Amravati newspaper, and are developing a wide interest that is
          obvious from their hand-written magazine, <i>Inspiration</i>. Some
        ...
        <div class="staff-images">
          <?php
           ...
           $image_extensions = array("png","jpg","jpeg","gif", "JPG");
           // Target directory
           $dir = 'resources/images/About/Activities/Icons';
           if (is_dir($dir)){
      ...
      <div class="content" style="min-width: 700px;">
        <div class="testimony-container">
          <div class="testimony-image">
            ...
            <div class="quote-plus-author serif">
              <div class="quote">
                I have a dream job of inspiring love of reading. My aim is to make
                every student in Satnoor a reader. I have established close links
                with families, communities and school.
              </div>
              <div class="quote-author">
                &ndash;   Ravi (Nachiket Staff Member)
              </div>
            </div>
        </div>
      </div>
        ...
        <div class="about-container">
          <div id="founder-text-container">
            ...
            <p>Asha Pawagi grew up in Amravati, Maharashtra and immigrated to
              ...
              Public Library which later inspired her to found Nachiket
              Children's Libraries in 2004.
            </p><br>

            <p>Asha earned her Ph. D in biochemistry from the University of
              Toronto in 1990 and worked in cell membrane research relating to
  ...
  <div class="content-container" style="background: #FFF;">
    <div class="content" style="padding-top:20px;">
      <div class="quote-container resizeable">
        ...
        <div class="quote-plus-author serif">
          <div class="quote">
            Yes, we have little education and we do have to work hard at low
            paying jobs. The joy that Nachiket's storyteller brings to us and to
            our children, how could we ever describe it? We never imagined that
            even our little ones would get attached to books. Now we hope that
            our children, boys and girls, will have a better future.
          <div class="quote-author">
            &ndash; Mothers
          </div>
        </div>
